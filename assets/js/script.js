...
function colorCode() {
  ...
  if (now > 13) {
    $("#comment01pm").addClass("past");
  } else if (now >= 13 && now < 14) {
    $("#comment01pm").addClass("present");
  } else if (now < 13) {
    $("#comment01pm").addClass("future");
  }
  if (now > 14) {
    $("#comment02pm").addClass("past");
  } else if (now >= 14 && now < 15) {
    $("#comment02pm").addClass("present");
  } else if (now < 14) {
    $("#comment02pm").addClass("future");
  }
  if (now > 15) {
    $("#comment03pm").addClass("past");
  } else if (now >= 15 && now < 16) {
    $("#comment03pm").addClass("present");
  } else if (now < 15) {
    $("#comment03pm").addClass("future");
  }
  if (now > 16) {
    $("#comment04pm").addClass("past");
  } else if (now >= 16 && now < 17) {
    $("#comment04pm").addClass("present");
  } else if (now < 16) {
    $("#comment04pm").addClass("future");
  }
  if (now > 17) {
    $("#comment05pm").addClass("past");
  } else if (now >= 17 && now < 18) {
    $("#comment05pm").addClass("present");
  } else if (now < 17) {
    $("#comment05pm").addClass("future");
  }
}
...
function onePM() {
  var input_textarea5 = document.querySelector("#comment01pm");
  var output_div5 = document.querySelector("#comment01pm");
  var save_button5 = document.querySelector("#button01pm");
...
function twoPM() {
  var input_textarea6 = document.querySelector("#comment02pm");
  var output_div6 = document.querySelector("#comment02pm");
  var save_button6 = document.querySelector("#button02pm");
...
function threePM() {
  var input_textarea7 = document.querySelector("#comment03pm");
  var output_div7 = document.querySelector("#comment03pm");
  var save_button7 = document.querySelector("#button03pm");
...
function fourPM() {
  var input_textarea8 = document.querySelector("#comment04pm");
  var output_div8 = document.querySelector("#comment04pm");
  var save_button8 = document.querySelector("#button04pm");
...
function fivePM() {
  var input_textarea9 = document.querySelector("#comment05pm");
  var output_div9 = document.querySelector("#comment05pm");
  var save_button9 = document.querySelector("#button05pm");
